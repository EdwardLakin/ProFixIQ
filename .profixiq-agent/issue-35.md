# ProFixIQ Agent Task for issue #35

**Title:** ProFixIQ feature: Error at the top of work order create page on page load.

**Description (raw):**

Error at the top of work order create page on page load.

---
**Normalized payload:**
```json
{
  "id": "76e4f7fb-7a6c-4485-b734-8909b7c850bc",
  "kind": "bug",
  "title": "ProFixIQ bug report",
  "description": "Error at the top of work order create page on page load.",
  "source": "owner",
  "reporterId": "8764f87e-a991-4388-b233-11c47e28c3ed",
  "shopId": "e4d23a6d-9418-49a5-8a1b-6a2640615b5b",
  "createdAt": "2025-11-17T22:50:29.818Z",
  "hints": [
    {
