...
export function VehicleOnboardingSetupCard({ guidedQuery, addVehicleTargetId = "add-vehicle" }: Props) {
  ...
  return (
    ...
    >
      <section data-testid="vehicles-onboarding-card" className="rounded-2xl border border-[color:var(--desktop-border)] bg-[var(--theme-gradient-panel)] p-4 shadow-[var(--theme-shadow-medium)]">
        <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
          <div className="max-w-3xl">
            ...
            <h2 className="mt-2 text-xl font-semibold text-[color:var(--theme-text-primary)]">Vehicle import/setup</h2>
          ...
          <div className="flex w-full flex-col gap-2 lg:w-auto lg:min-w-72">
            ...
            <button type="button" onClick={() => void postStepAction("skip")} disabled={disabled} className="rounded-xl border border-[color:var(--theme-border-soft)] bg-[color:var(--theme-surface-subtle)] px-4 py-2 text-sm font-semibold text-[color:var(--theme-text-primary)] hover:bg-[color:var(--theme-surface-subtle)] disabled:opacity-55">
