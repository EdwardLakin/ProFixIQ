...
export const GUIDED_ONBOARDING_STEPS = [
  ...
  },
  {
    ...
    description: "Route to Billing so historical invoice import stays connected to the real invoice workflow.",
  ...
  },
  {
    ...
    description: "Route to work order history so past repairs stay tied to the real service history surface.",
    implementationStatus: "future",
  },
