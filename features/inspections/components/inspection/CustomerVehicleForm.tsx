    ...
    <div className="w-full max-w-2xl mx-auto text-white space-y-6 mb-10">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <input
          ...
          onChange={(e) => onCustomerChange("first_name", e.target.value)}
        />
        <input
          className="input"
          placeholder="Last Name"
          value={customer.last_name ?? ""}
          onChange={(e) => onCustomerChange("last_name", e.target.value)}
        />
        <input
          className="input"
          placeholder="Phone"
        ...
        <input
          ...
          onChange={(e) => onCustomerChange("province", e.target.value)}
        />
        <input
          className="input"
