  ...
  return (
    <>
      ...
      <div className="fixed left-1/2 top-1/2 z-[71] max-h-[calc(100vh-32px)] w-[min(760px,calc(100vw-32px))] -translate-x-1/2 -translate-y-1/2 overflow-hidden rounded-2xl border border-[color:var(--theme-border-soft)] bg-[color:var(--theme-surface-page)] shadow-2xl">
        ...
        {footer ? <div className="border-t border-[color:var(--theme-border-soft)] bg-[color:var(--theme-surface-subtle)] px-5 py-4">{footer}</div> : null}
      </div>
    </>
  );
}
...
export const modalInput =
  "w-full rounded-lg border border-[color:var(--theme-border-soft)] bg-[color:var(--theme-surface-page)] px-3 py-2 text-sm text-[color:var(--theme-text-primary)] placeholder:text-[color:var(--theme-text-muted)] focus:outline-none focus:ring-2 focus:ring-sky-500/30";

export const modalButton =
  "rounded-lg border border-[color:var(--theme-border-soft)] bg-[color:var(--theme-surface-panel)] px-3 py-2 text-sm font-medium text-[color:var(--theme-text-primary)] hover:bg-[color:var(--theme-surface-subtle)]";

export const modalPrimaryButton =
  "rounded-lg border border-orange-500/35 bg-orange-600/85 px-4 py-2 text-sm font-semibold text-[color:var(--theme-text-primary)] hover:bg-orange-500";
