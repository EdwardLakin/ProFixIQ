...
export function PurchaseOrderReceivePanel({ poId }: { poId: string }): JSX.Element {
  ...
  return (
    <section id="receive" className="space-y-4 text-[color:var(--theme-text-primary)]" aria-labelledby="receive-po-title">
      <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
        <div>
          <div className="text-xs uppercase tracking-[0.22em] text-[color:var(--theme-text-secondary)]">Purchase order</div>
          <h2 id="receive-po-title" className="text-2xl font-bold">Receive this PO</h2>
