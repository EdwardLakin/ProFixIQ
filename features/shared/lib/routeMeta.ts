// src/routeMeta.ts (or wherever this file lives)
...
export const ROUTE_META: Record<string, RouteMeta> = {
  ...
  // NEW: Scheduling (Admin)
  "/dashboard/admin/scheduling":  { title: () => "Scheduling",     icon: "📅", showInTabs: true },
  ...
  "/compare-plans": { title: () => "Plan & Billing", icon: "💳", showInTabs: true }, // leave visible if you want
};
...
export function metaFor(href: string): { title: string; icon?: string; show: boolean } {
  ...
  // Fallback: make a readable title from the last segment
