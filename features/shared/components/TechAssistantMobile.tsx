...
export default function TechAssistantMobile({
  ...
  // restore context if needed (hook already persists thread; this keeps parity if used standalone)
  useEffect(() => {
    // no-op: state is persisted by the hook
  }, []);
  ...
  return (
    <div className="flex h-[calc(100vh-5rem)] flex-col text-white md:hidden">
      ...
      <div className="relative flex-1 overflow-y-auto p-3 pt-2">
        ...
        {/* Bottom spacer so last bubble isn’t hidden behind the composer */}
        <div className="h-28" />
      </div>
