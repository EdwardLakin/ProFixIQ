    ...
    <nav className="w-full md:w-64 bg-neutral-900 p-4 text-white space-y-6">
      <div>
        ...
        <div className="space-y-1">
          <Link href="/dashboard/parts" className="block hover:text-orange-400">
            Parts Dashboard
          </Link>
          <Link href="/parts/inventory" className="block hover:text-orange-400">
            Inventory
          </Link>
          <Link href="/parts/returns" className="block hover:text-orange-400">
            Returns
          </Link>
          <Link
