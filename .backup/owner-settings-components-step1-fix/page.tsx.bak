...
;
  ...
  const seatPill = (() => {
    ...
    <div className="mx-auto flex max-w-7xl flex-col gap-5 p-5 text-foreground lg:p-6">
      <div className="flex flex-wrap items-center justify-between gap-3 rounded-2xl border border-white/10 bg-black/25 px-5 py-4">
        <div>
      ...
      <div className="grid gap-5 lg:grid-cols-[1.7fr_0.95fr] lg:items-start">
        <div className="space-y-5">
          <section id="shop-info" className={sectionClass}>
