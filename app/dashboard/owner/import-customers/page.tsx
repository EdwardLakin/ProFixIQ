...
export default function ImportCustomersPage() {
  ...
  const importData = async () => {
    ...
    for (const row of parsedData) {
      const mapped = Object.entries(columnMapping).reduce((acc, [original, mappedKey]) => {
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 text-white">
      <h1 className="text-3xl font-bold text-orange-400 mb-6">Import Customers & Vehicles</h1>
      ...
      <div className="space-y-4">
        ...
        {parsedData.length > 0 && (
          <>
            <p className="text-sm text-green-400 mt-4">{parsedData.length} rows ready to import.</p>
