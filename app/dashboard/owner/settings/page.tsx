  ...
  return (
    <div className="max-w-3xl mx-auto p-6 space-y-10 text-white">
      ...
      <section className="space-y-2">
        ...
        <Button onClick={handleGenerateLogo} variant="secondary">Generate Logo with AI</Button>
        {logoUrl && (
      ...
      <section className="space-y-2">
        ...
        <label><input type="checkbox" checked={useAi} onChange={(e) => setUseAi(e.target.checked)} /> Use AI features</label><br />
        <label><input type="checkbox" checked={requireCauseCorrection} onChange={(e) => setRequireCauseCorrection(e.target.checked)} /> Require cause/correction</label><br />
        <label><input type="checkbox" checked={requireAuthorization} onChange={(e) => setRequireAuthorization(e.target.checked)} /> Require customer authorization</label>
      </section>
      ...
      <section className="space-y-2">
        ...
        <label><input type="checkbox" checked={emailOnComplete} onChange={(e) => setEmailOnComplete(e.target.checked)} /> Email customer when job is complete</label>
      </section>
      ...
      <section className="space-y-2 bg-neutral-800 p-4 rounded-md">
        ...
        <div className="bg-white text-black p-4 rounded shadow space-y-2">
          ...
          <div className="text-xs">{phone} • {email}</div>
          <hr />
      ...
      <section className="space-y-2">
        ...
        <label><input type="checkbox" checked={autoGeneratePdf} onChange={(e) => setAutoGeneratePdf(e.target.checked)} /> Auto-generate quote PDF</label><br />
        <label><input type="checkbox" checked={autoSendQuoteEmail} onChange={(e) => setAutoSendQuoteEmail(e.target.checked)} /> Auto-send quote email</label>
      </section>
