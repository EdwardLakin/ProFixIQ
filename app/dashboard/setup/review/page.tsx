  ...
  return (
    ...
    >
      <div className="rounded-2xl border border-[color:var(--theme-border-soft)] bg-[color:var(--theme-surface-inset)] p-4">
        <h1 className="text-xl font-semibold text-[color:var(--theme-text-primary)]">Shop Boost Guided Review (Legacy)</h1>
        <p className="mt-1 text-sm text-[color:var(--theme-text-secondary)]">Resolve migration issues in guided steps with transparent reasoning and confidence-backed actions.</p>
        <p className="mt-1 text-xs text-[color:var(--theme-text-secondary)]">This page keeps checking readiness in the background and will auto-continue once activation truth flips ready.</p>
        <div className="mt-3 flex flex-wrap gap-2 text-xs text-[color:var(--theme-text-secondary)]">
          {Object.entries(grouped).map(([key, count]) => (
            <span key={key} className="rounded-full border border-[color:var(--theme-border-soft)] px-2 py-1">{key}: {count}</span>
          ))}
        </div>
        {summary ? (
          <div className="mt-3 rounded-lg border border-[color:var(--theme-border-soft)] bg-[color:var(--theme-surface-inset)] px-3 py-2 text-xs text-[color:var(--theme-text-primary)]">
        ...
        {guidance ? (
          <div className={`mt-3 rounded-lg border px-3 py-2 text-sm ${guidance.is_operational_ready ? "border-emerald-400/35 bg-emerald-950/20 text-emerald-100" : "border-cyan-300/25 bg-cyan-950/10 text-[color:var(--theme-text-primary)]"}`}>
            ...
            <div className="mt-1 text-xs text-[color:var(--theme-text-primary)]">Blockers: {guidance.operational_blockers_count} • Non-blocking issues: {guidance.non_blocking_issues_count} • High-risk actions: {guidance.high_risk_actions_count ?? 0}</div>
      ...
      {isOwnerOrAdmin ? (
        <section className="rounded-xl border border-[color:var(--theme-border-soft)] bg-[color:var(--theme-surface-inset)] p-4 space-y-3">
          <div>
            <h2 className="text-sm font-semibold text-[color:var(--theme-text-primary)]">Reset this intake</h2>
            <p className="mt-1 text-xs text-[color:var(--theme-text-primary)]">
          ...
          <div className="rounded-lg border border-[color:var(--theme-border-soft)] bg-[color:var(--theme-surface-inset)] px-3 py-2 text-xs text-[color:var(--theme-text-primary)]">
          ...
          <div className="grid gap-3 md:grid-cols-[1.7fr_1fr]">
            <div>
              <label className="text-xs uppercase tracking-[0.16em] text-[color:var(--theme-text-secondary)]">Intake scope (required)</label>
              <input
                value={resetIntakeId}
                onChange={(e) => {
                ...
                className="mt-2 w-full rounded-md border border-[color:var(--theme-border-soft)] bg-[color:var(--theme-surface-inset)] px-3 py-2 text-sm text-[color:var(--theme-text-primary)]"
              />
            </div>
          ...
          {previewCounts ? (
            <div className="space-y-3 rounded-lg border border-[color:var(--theme-border-soft)] bg-[color:var(--theme-surface-inset)] p-3">
              <div className="grid gap-3 md:grid-cols-2 text-xs">
                <div className="rounded-md border border-emerald-300/35 bg-emerald-950/20 p-2">
                  ...
                  <ul className="mt-1 space-y-1 text-[color:var(--theme-text-primary)]">
              ...
              <div className="grid gap-2 text-xs md:grid-cols-2">
                <div className="rounded-md border border-[color:var(--theme-border-soft)] p-2 text-[color:var(--theme-text-primary)]">Intake rows: {previewCounts.intakes}</div>
                <div className="rounded-md border border-[color:var(--theme-border-soft)] p-2 text-[color:var(--theme-text-primary)]">Review items: {previewCounts.reviewItems}</div>
                <div className="rounded-md border border-[color:var(--theme-border-soft)] p-2 text-[color:var(--theme-text-primary)]">Row results: {previewCounts.rowResults}</div>
                <div className="rounded-md border border-[color:var(--theme-border-soft)] p-2 text-[color:var(--theme-text-primary)]">Review audit events: {previewCounts.reviewAuditEvents}</div>
                <div className="rounded-md border border-[color:var(--theme-border-soft)] p-2 text-[color:var(--theme-text-primary)]">Integrity reports: {previewCounts.integrityReports}</div>
                <div className="rounded-md border border-[color:var(--theme-border-soft)] p-2 text-[color:var(--theme-text-primary)]">Import files: {previewCounts.importFiles}</div>
                <div className="rounded-md border border-[color:var(--theme-border-soft)] p-2 text-[color:var(--theme-text-primary)]">Import rows: {previewCounts.importRows}</div>
                <div className="rounded-md border border-[color:var(--theme-border-soft)] p-2 text-[color:var(--theme-text-primary)]">Staff invite suggestions: {previewCounts.staffInviteSuggestions}</div>
                <div className="rounded-md border border-[color:var(--theme-border-soft)] p-2 text-[color:var(--theme-text-primary)]">Staff invite candidates: {previewCounts.staffInviteCandidates}</div>
              </div>

              <div className="rounded-md border border-[color:var(--theme-border-soft)] bg-[color:var(--theme-surface-inset)] p-2 text-xs text-[color:var(--theme-text-primary)]">
                <div className="font-semibold text-[color:var(--theme-text-primary)]">Required confirmation text</div>
                <div className="mt-1 break-all font-mono text-[11px]">{resetPreview?.expectedConfirmationText}</div>
                <button
                  type="button"
                  className="mt-2 rounded border border-[color:var(--theme-border-soft)] px-2 py-1 text-[11px] text-[color:var(--theme-text-primary)]"
              ...
              <input
                ...
                className="w-full rounded-md border border-[color:var(--theme-border-soft)] bg-[color:var(--theme-surface-inset)] px-3 py-2 text-xs text-[color:var(--theme-text-primary)]"
              />
          ...
          {resetExecute?.deletedCounts ? (
            <div className="rounded-lg border border-emerald-300/30 bg-emerald-950/20 p-3 text-xs text-emerald-100">
              ...
              <pre className="mt-2 overflow-auto rounded border border-[color:var(--theme-border-soft)] bg-[color:var(--theme-surface-inset)] p-2 text-[11px] text-[color:var(--theme-text-primary)]">{JSON.stringify(resetExecute.deletedCounts, null, 2)}</pre>
              {resetExecute.notes?.legacyTaggedNotDeleted ? (
                <div className="mt-2 text-cyan-100">
                  Legacy-tagged records still not auto-deleted:
                  <pre className="mt-1 overflow-auto rounded border border-cyan-300/25 bg-[color:var(--theme-surface-inset)] p-2 text-[11px] text-[color:var(--theme-text-primary)]">{JSON.stringify(resetExecute.notes.legacyTaggedNotDeleted, null, 2)}</pre>
                </div>
              ) : null}
            </div>
          ) : null}
        ...
        <section className="rounded-xl border border-[color:var(--theme-border-soft)] bg-[color:var(--theme-surface-inset)] p-4">
          <div className="text-xs text-[color:var(--theme-text-secondary)]">Intake reset controls are visible to owner/admin roles only.</div>
        </section>
      )}

      <div className="rounded-xl border border-[color:var(--theme-border-soft)] bg-[color:var(--theme-surface-inset)] p-3 space-y-3">
        <div className="grid gap-3 md:grid-cols-2">
          <div>
            <label className="text-xs uppercase tracking-[0.16em] text-[color:var(--theme-text-secondary)]">Filter by domain</label>
            <select value={domain} onChange={(e) => setDomain(e.target.value)} className="mt-2 w-full rounded-md border border-[color:var(--theme-border-soft)] bg-[color:var(--theme-surface-inset)] px-3 py-2 text-sm text-[color:var(--theme-text-primary)]">
              {domains.map((d) => <option key={d || "all"} value={d}>{d || "all domains"}</option>)}
            </select>
          </div>
          <div>
            <label className="text-xs uppercase tracking-[0.16em] text-[color:var(--theme-text-secondary)]">Filter by status</label>
            <select value={statusFilter} onChange={(e) => setStatusFilter(e.target.value)} className="mt-2 w-full rounded-md border border-[color:var(--theme-border-soft)] bg-[color:var(--theme-surface-inset)] px-3 py-2 text-sm text-[color:var(--theme-text-primary)]">
        ...
        <div className="grid gap-2 md:grid-cols-3 text-xs">
          ...
          <button className="rounded border border-[color:var(--theme-border-soft)] px-2 py-1 text-[color:var(--theme-text-primary)]" onClick={() => void runReprocess("unresolved")} disabled={reprocessBusy !== null}>{reprocessBusy === "unresolved" ? "Re-running…" : "Re-run unresolved items"}</button>
      ...
      <div className="grid gap-3 md:grid-cols-3">
        {[
          ...
          <details key={step.key} className="rounded-xl border border-[color:var(--theme-border-soft)] bg-[color:var(--theme-surface-inset)] p-3" open={step.rows.length > 0}>
            <summary className="cursor-pointer text-sm font-semibold text-[color:var(--theme-text-primary)]">{step.title}</summary>
            <div className="mt-2 text-xs text-[color:var(--theme-text-secondary)]">{step.rows.length} item(s) in this step.</div>
            {step.rows.length === 0 ? <div className="mt-2 text-xs text-emerald-200">Complete ✅</div> : <div className="mt-2 text-xs text-[color:var(--theme-text-secondary)]">Use item actions below to {step.cta.toLowerCase()}.</div>}
          </details>
        ))}
      </div>

      <div>
        <label className="text-xs uppercase tracking-[0.16em] text-[color:var(--theme-text-secondary)]">Ignore reason</label>
        <select value={ignoreReason} onChange={(e) => setIgnoreReason(e.target.value)} className="mt-2 w-full rounded-md border border-[color:var(--theme-border-soft)] bg-[color:var(--theme-surface-inset)] px-3 py-2 text-sm text-[color:var(--theme-text-primary)]">
        ...
        <input value={ignoreNote} onChange={(e) => setIgnoreNote(e.target.value)} placeholder="Optional ignore note" className="mt-2 w-full rounded-md border border-[color:var(--theme-border-soft)] bg-[color:var(--theme-surface-inset)] px-3 py-2 text-sm text-[color:var(--theme-text-primary)]" />
      </div>
      ...
      {selectedIds.length > 0 ? (
        <div className="flex flex-wrap gap-2 text-xs">
          ...
          <button className="rounded border border-[color:var(--theme-border-soft)] px-2 py-1 text-[color:var(--theme-text-primary)]" onClick={() => void resolveBulk("ignored")}>Bulk ignore</button>
        </div>
      ) : null}

      {loading ? <div className="text-sm text-[color:var(--theme-text-secondary)]">Loading review queue…</div> : items.length === 0 ? (
        ...
        <div className="space-y-3">
          {items.map((item) => (
            <div key={item.id} className="rounded-xl border border-[color:var(--theme-border-soft)] bg-[color:var(--theme-surface-inset)] p-3">
              <div className="flex flex-wrap items-start justify-between gap-3">
                <div className="flex gap-2">
                  <input type="checkbox" checked={selectedIds.includes(item.id)} onChange={() => toggleSelected(item.id)} className="mt-1" />
                  <div>
                    <div className="text-sm font-semibold text-[color:var(--theme-text-primary)]">{item.summary}</div>
                    <div className="text-xs text-[color:var(--theme-text-secondary)]">{item.domain} • {item.issue_type} • {item.status}</div>
                    {item.blocking_reason ? <div className="text-xs text-amber-200">Blocker: {item.blocking_reason}</div> : null}
                    <div className="mt-1 text-xs text-[color:var(--theme-text-primary)]">Why this needs review: {item.review_explanation}</div>
                ...
                <div className="w-full max-w-sm rounded-lg border border-[color:var(--theme-border-soft)] bg-[color:var(--theme-surface-inset)] p-2 text-xs">
                  <div className="flex items-center justify-between">
                    <div className="font-medium text-[color:var(--theme-text-primary)]">Suggested: {actionLabel(item.recommendation.recommendedAction)}</div>
                  ...
                  {item.recommendation.candidateTargets.length > 0 ? (
                    <div className="mt-1 text-[color:var(--theme-text-secondary)]">Candidates: {item.recommendation.candidateTargets.map((t) => `${t.label} (${Math.round(t.score * 100)}%)`).join(" • ")}</div>
                  ) : null}
                  <div className="mt-2 flex flex-wrap gap-2">
                    ...
                    <button className="rounded border border-[color:var(--theme-border-soft)] px-2 py-1 text-[color:var(--theme-text-primary)]" onClick={() => void resolveSingle(item, "created_new")}>Manual create</button>
                  </div>
              ...
              <details className="mt-3 rounded-lg border border-[color:var(--theme-border-soft)] bg-[color:var(--theme-surface-inset)] p-2">
                <summary className="cursor-pointer text-xs font-medium text-[color:var(--theme-text-primary)]">Decision transparency panel</summary>
                <div className="mt-2 grid gap-3 md:grid-cols-3">
                  <div>
                    <div className="mb-1 text-xs uppercase tracking-[0.14em] text-[color:var(--theme-text-muted)]">Raw data</div>
                    <pre className="max-h-64 overflow-auto rounded border border-[color:var(--theme-border-soft)] bg-[color:var(--theme-surface-inset)] p-2 text-xs text-[color:var(--theme-text-primary)]">{JSON.stringify(item.decision_transparency.raw_data ?? {}, null, 2)}</pre>
                  </div>
                  <div>
                    <div className="mb-1 text-xs uppercase tracking-[0.14em] text-[color:var(--theme-text-muted)]">Normalized data</div>
                    <pre className="max-h-64 overflow-auto rounded border border-[color:var(--theme-border-soft)] bg-[color:var(--theme-surface-inset)] p-2 text-xs text-[color:var(--theme-text-primary)]">{JSON.stringify(item.decision_transparency.normalized_data ?? {}, null, 2)}</pre>
                  </div>
                  <div>
                    <div className="mb-1 text-xs uppercase tracking-[0.14em] text-[color:var(--theme-text-muted)]">Candidates + confidence</div>
                    <div className="mb-2 text-xs text-[color:var(--theme-text-secondary)]">Confidence score: {(item.decision_transparency.confidence_score * 100).toFixed(0)}%</div>
                    <div className="mb-2 text-xs text-[color:var(--theme-text-secondary)]">Reasoning: {item.decision_transparency.reasoning}</div>
                    <pre className="max-h-64 overflow-auto rounded border border-[color:var(--theme-border-soft)] bg-[color:var(--theme-surface-inset)] p-2 text-xs text-[color:var(--theme-text-primary)]">{JSON.stringify(item.decision_transparency.candidates ?? [], null, 2)}</pre>
                  </div>
                </div>
              </details>
              ...
              {item.status === "ignored" ? <div className="mt-1 text-xs text-[color:var(--theme-text-secondary)]">Ignored ({item.ignore_reason_code ?? "other"}) {item.ignore_note ? `• ${item.ignore_note}` : ""}</div> : null}
