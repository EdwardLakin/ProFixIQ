...
export default async function PortalInvoicePage({ params }: PageProps) {
  ...
  const invoiceTotal =
    ...
    (Number(workOrder.labor_total || 0) + Number(workOrder.parts_total || 0));
          ...
          <div className="mb-6 grid gap-4 sm:grid-cols-3">
            ...
            <div className="rounded-2xl border border-white/10 bg-black/40 px-4 py-3">
              ...
              <div className="mt-0.5 text-[11px] text-neutral-500">
                Approval: {workOrder.approval_state ?? "—"}
              </div>
            </div>
            ...
            <div className="rounded-2xl border border-white/10 bg-black/40 px-4 py-3">
              ...
              <div className="mt-1 text-sm font-semibold text-neutral-100">
                {formatDate(workOrder.invoice_sent_at)}
              </div>
              <div className="mt-0.5 text-[11px] text-neutral-500">
                To: {workOrder.invoice_last_sent_to || "—"}
              </div>
            </div>
          </div>
