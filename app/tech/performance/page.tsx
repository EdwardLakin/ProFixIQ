                ...
                <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
                  <div>
                    ...
                    <p className="mt-2 text-sm text-neutral-300">
                      This panel is your personal scoreboard – revenue, hours and
                ...
                <div className="flex flex-col items-end text-right text-[0.75rem] text-neutral-300">
                  <span>
                    ...
                    <span className="font-semibold text-emerald-300">
                      {row.laborCost > 0 ? (row.revenue / row.laborCost).toFixed(1) + "×" : "–"}
                    </span>
                  </span>
                  <span className="text-neutral-500">Target: 2.5×+ over time.</span>
                </div>
              </div>
            </section>
          </>
