...
import { AI } from "@/features/integrations/ai";
...
function isRequestBody(value: unknown): value is RequestBody {
  ...
  return typeof obj.item === "string" && typeof obj.section === "string" && typeof obj.status === "string";
}
...
function buildVehicleYmm(vehicle?: VehicleInput | null): string | null {
  ...
  const year = vehicle.year !== undefined && vehicle.year !== null ? String(vehicle.year) : "";
...
export async function POST(req: Request) {
  ...
  try {
    ...
    const aiResult = await AI.suggestQuote({
