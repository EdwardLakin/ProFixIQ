...
export async function POST(req: Request) {
  ...
  if (hasAcquisitionSession) {
    try {
      ...
      // The claim endpoint remains the sole authority that links checkout,
      // identity, tenant, and billing. This response only keeps the freshly
      // authenticated session alive long enough for that atomic claim.
