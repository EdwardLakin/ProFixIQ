        ...
        <div className="w-full max-w-6xl space-y-5">
          <div className={card + " relative overflow-hidden px-4 py-4 md:px-6 md:py-5"}>
            ...
            <div className="relative">
              ...
              <p className="mt-1 text-xs text-neutral-300">
                Assign units, drivers and routes. This is a placeholder shell wired to the correct
                route so we can layer in the full dispatch UI next.
              </p>
            </div>
          </div>
          ...
          <div className={card + " px-4 py-4 md:px-6 md:py-5"}>
            <p className="text-xs text-neutral-300">
              ...
              is now live and wrapped in the dashboard shell.
            </p>
