...
export default async function Page({ params, searchParams }: { params: Promise<{ id: string }>; searchParams?: Promise<Record<string, string | string[] | undefined>> }) {
  ...
  return <main className="min-h-screen bg-[radial-gradient(circle_at_top,rgba(193,122,74,0.14),transparent_35%),#030712] p-6 text-white"><div className="mx-auto max-w-6xl space-y-4"><div className="flex items-start justify-between"><div><h1 className="text-2xl font-semibold">Property inspection</h1><p className="text-sm text-neutral-400">Dedicated property inspection record (no quote/work-order flow).</p></div><div className="flex gap-3 text-xs"><Link href={`/property/inspections/${row.id}/print`} className="underline">Print / Export</Link><Link href="/property/inspections" className="underline">Back</Link></div></div>
