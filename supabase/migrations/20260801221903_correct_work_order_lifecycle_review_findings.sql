...
-- Correct the lifecycle projection introduced by the prior migration without
-- rewriting deployed migration history. Completed-but-uninvoiced work remains
-- in the billing handoff, and unresolved decisions outrank authorization.
