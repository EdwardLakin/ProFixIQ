...
-- Canonical metadata required by mobile/desktop job-photo evidence.
...
-- Existing clients upload to:
--   job-photos/wo/<workOrderId>/lines/<workOrderLineId>/<clientMutationId>_<fileName>
-- Register that object as durable evidence in the same storage.objects transaction.
