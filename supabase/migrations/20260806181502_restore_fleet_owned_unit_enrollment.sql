...
-- Re-apply the Fleet-owned enrollment boundary under a new forward version.
-- Production recorded later Fleet migrations but never executed the original
-- 20260806021000 function replacement.
