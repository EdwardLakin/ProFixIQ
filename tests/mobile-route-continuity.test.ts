...
describe("mobile route continuity", () => {
  it.each([
    ...
    ["/chat/chat-1?focus=latest", "/mobile/messages/chat-1?focus=latest"],
    ["/copilot/technician", "/mobile/copilot/technician"],
    ["/customers/customer-1", "/mobile/customers/customer-1"],
    ["/customers/search", "/mobile/work-orders"],
    ["/customers/directory", "/mobile/work-orders"],
    ["/customers/all", "/mobile/work-orders"],
