...
describe("AI ledger reporting indexes", () => {
  it("indexes shop/user/feature/model dimensions by occurrence time", () => {
    ...
    expect(migration).toContain("ai_usage_ledger_model_month_idx");
  });
});
