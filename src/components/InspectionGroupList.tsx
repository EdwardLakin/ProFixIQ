...
import type { InspectionCategory } from '@lib/inspection/masterInspectionList';
...
export default function InspectionGroupList({ categories, editable = false }: Props) {
    ...
    <div className="space-y-4">
      {categories.map((section) => (
        ...
        >
          ...
          >
            <span className="text-orange-400 font-semibold">{section.title}</span>
