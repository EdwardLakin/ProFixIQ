  ...
  const features = [
    ...
    <>
      ...
      <section id="features" className="pt-20 px-6 max-w-5xl mx-auto text-white">
        <h2 className="text-4xl font-blackops text-center mb-10 text-orange-400 drop-shadow-lg">Powerful Features</h2>
        ...
        <div className="max-w-6xl mx-auto text-center">
          <h2 className="text-3xl font-blackops text-orange-400 mb-6 drop-shadow">Why ProFixIQ?</h2>
          <p className="text-lg text-gray-300 leading-relaxed">
            ProFixIQ was built by a technician who lived the shop life — not a corporate product manager.
            We know the real bottlenecks: the hours spent at a desk quoting jobs, chasing approvals,
            writing work orders, and double-checking inspections.
            That’s why we built ProFixIQ to be your digital assistant — AI-powered, voice-enabled,
            and built to streamline everything from diagnostics to dispatch.
            Whether you’re a solo tech or running a full shop, ProFixIQ reduces screen time,
            speeds up workflows, and gives you more time to do what you do best — Repair vehicles.
          </p>
        </div>
      </section>
      ...
      <section className="py-20 bg-black text-white px-6">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl font-blackops text-orange-400 text-center mb-10 drop-shadow">What Our Users Say</h2>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="bg-neutral-900 p-6 rounded-xl shadow hover:shadow-orange-500/20 transition">
      ...
      <section id="plans" className="py-20 bg-neutral-900 px-6 text-white">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl font-blackops text-orange-400 text-center mb-8 drop-shadow">Choose Your Plan</h2>
