...
import { FaClipboardList, FaWrench, FaComments, FaChevronDown, FaChevronRight } from 'react-icons/fa';
      ...
      <div>
        ...
        {openSection === 'advising' && (
          <div className="space-y-1 ml-2">
            ...
            <Link href="/dashboard/advisor" className={linkClass('/dashboard/advisor')}>
