...
import {
  FaTools, FaCogs, FaClipboardList, FaBoxOpen,
  FaRegChartBar, FaUserPlus, FaWrench, FaChevronDown, FaChevronUp,
} from 'react-icons/fa';
    ...
    <>
      ...
      >
        ...
        <NavSection title="Inspections" icon={<FaClipboardList />} sectionKey="inspection">
          ...
          <Link href="/inspection/custom-inspection" className="block hover:text-orange-400">Custom Builder</Link>
          <Link href="/inspection/saved" className="block hover:text-orange-400">Saved Inspections</Link>
          <Link href="/inspection/templates" className="block hover:text-orange-400">Templates</Link>
        </NavSection>
        ...
        <NavSection title="AI Tools" icon={<FaCogs />} sectionKey="ai">
          <Link href="/ai/photo" className="block hover:text-orange-400">AI Photo</Link>
          <Link href="/ai/dtc" className="block hover:text-orange-400">DTC Decoder</Link>
          <Link href="/ai/chat" className="block hover:text-orange-400">AI Chat</Link>
        </NavSection>

        <NavSection title="Tech Tools" icon={<FaTools />} sectionKey="tech">
          <Link href="/tech/queue" className="block hover:text-orange-400">Tech Job Queue</Link>
        </NavSection>
